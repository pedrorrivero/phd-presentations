...
\title{Toward Understanding Mass Using a Quantum Computer} % Poster title

\author{Pedro Rivero Ramírez$^\text{1,2}$, Ian C. Cloët$^\text{1}$, and Zack Sullivan$^\text{2}$} % Author(s)
...
\setbeamercolor{block title}{fg=RedOrange,bg=white} % Change the block title color
...
\begin{center}
\begin{tabular}{ccc}
\includegraphics[height=0.25\linewidth]{LOGOS/LOGO-3.png} & \hfill & \includegraphics[height=0.25\linewidth]{LOGOS/LOGO-4.png}
\end{tabular}
\end{center}
...
\setbeamercolor{block alerted title}{fg=black,bg=SpringGreen} % Change the alert block title colors
\setbeamercolor{block alerted body}{fg=black,bg=white} % Change the alert block body colors

\begin{alertblock}{Contact Information}

\begin{itemize}
\item Email: \href{mailto:priveroramirez@anl.gov}{priveroramirez@anl.gov}
% \item Phone: +1 (000) 111-1111
\item Linkedin: \href{https://www.linkedin.com/in/pedrorrivero/}{pedrorrivero}
\end{itemize}
